# Getting Started with Winsteps Control Files and Batch Processing
...
`r_control_file` has 5 required arguments and 6 optional arguments, which we will cover later. The required arguments are:
