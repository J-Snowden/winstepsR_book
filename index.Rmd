--- 
title: "A Guide On How To Use winstepsR"
...
`select(ID, Dicot1:Dicot8)`: This part of the code is used to select specific columns from the dataset. The select function from the dplyr package allows you to specify which columns you want to keep in the new dataset:

- **ID**: Selects the column named ID.
- **Dicot1:Dicot8**: Selects all columns from Dicot1 to Dicot8.
